...
const Navbar = () => {
      ...
      const services = [
        { title: "Construction", icon: Building2, description: "Building and infrastructure" },
        { title: "Consultation", icon: Users, description: "Expert advisory services" },
      ...
      >
        <div className="container mx-auto px-6 lg:px-12 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="relative w-12 h-12 bg-yellow-400 rounded-full flex items-center justify-center font-bold text-[#001746] text-xl">
              PKM
            </div>
            <div className="text-white">
              <div className="text-xs tracking-wider opacity-80">PT. PELITA</div>
              <div className="font-bold text-sm text-yellow-400">KENCANA MANDIRI</div>
            </div>
          </div>
              ...
              <NavigationMenuList>
                <NavigationMenuItem>
                  <NavigationMenuLink asChild>
                    <a href="#home" className="text-white hover:text-yellow-400 transition-all text-sm font-medium">
                      Home
                    </a>
                  </NavigationMenuLink>
                </NavigationMenuItem>
                  ...
                  <NavigationMenuContent className="bg-[#001746]/95 backdrop-blur-lg p-4 border border-white/10 rounded-lg shadow-xl min-w-[300px]">
                    <ul className="grid gap-2">
                      {about.map((service, index) => {
                        ...
                        return (
                          <li key={index}>
                            <a href="#services" className="flex items-center gap-3 text-white hover:text-yellow-400">
                ...
                <NavigationMenuItem>
                  <NavigationMenuLink asChild>
                    <a href="#projects" className="text-white hover:text-yellow-400 text-sm font-medium">
                      Projects
                    </a>
                  </NavigationMenuLink>
                </NavigationMenuItem>
                ...
                <NavigationMenuItem>
                  <NavigationMenuLink asChild>
                    <a href="#contact" className="text-white hover:text-yellow-400 text-sm font-medium">
                      Contact
                    </a>
                  </NavigationMenuLink>
                </NavigationMenuItem>
        ...
        >
          <div className="flex flex-col gap-3 pb-4 px-6">
            <a href="#home" className="text-white hover:text-yellow-400 text-sm font-medium py-2 border-b border-white/10">
              Home
            </a>
            <div className="border-b border-white/10 pb-3">
              ...
              <div className="pl-3 space-y-2">
                {about.map((service, index) => (
                  <a key={index} href="#services" className="block text-white hover:text-yellow-400 text-sm py-1">
                    {service.title}
                  </a>
                ))}
              </div>
            ...
            <a href="#projects" className="text-white hover:text-yellow-400 text-sm font-medium py-2 border-b border-white/10">
              Projects
            </a>
            <a href="#contact" className="text-white hover:text-yellow-400 text-sm font-medium py-2 border-b border-white/10">
              Contact
            </a>
