        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-24">
            ...
            <div className="flex items-center space-x-3 sm:space-x-4 bg-gray-50 p-3 sm:p-4 rounded-lg border border-gray-200 mt-4 sm:mt-6">
                <span className="text-yellow-500 text-2xl sm:text-3xl font-bold shrink-0">07</span>
                <p className="text-xs sm:text-sm text-[#001746] font-semibold">Februari 2020: Perubahan manajemen kunci perusahaan.</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-8">
            ...
            <div className="p-4 sm:p-6 bg-white rounded-lg shadow-md border-t-4 border-yellow-500/50">
                <h3 className="text-lg sm:text-xl font-bold text-[#001746] mb-2 sm:mb-3">Sejarah Singkat</h3>
            ...
            <div>
                <h3 className="text-lg sm:text-xl font-bold text-[#001746] mb-3 sm:mb-4">Struktur Kepemimpinan (7 Februari 2020)</h3>
            ...
            <div className="p-4 sm:p-6 bg-[#001746]/5 rounded-lg border border-gray-200">
                <h3 className="text-lg sm:text-xl font-bold text-[#001746] mb-2 sm:mb-3">Komitmen Masa Depan</h3>
                <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
